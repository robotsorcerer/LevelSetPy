...
class DoubleIntegratorROB(DoubleIntegrator):
    def __init__(self, grid, u_bound=1):
        """
            Solve for the double integrator dynamics on a reduced basis.
    ...
    def mttr(self):
        """
            ...
            Take this as the value function.
        """
