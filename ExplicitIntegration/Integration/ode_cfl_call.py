...
def odeCFLcallPostTimestep(t, yIn, schemeDataIn, options):
    """
     ...
     parameters:
       t              Current time.
       yIn            Icp.t version of the level set function, in vector form.
       schemeDataIn   Icp.t version of a structure.
     ...
     The postTimestep routines called will determine whether and how
       yOut and schemeDataOut differ from their icp.t versions.
